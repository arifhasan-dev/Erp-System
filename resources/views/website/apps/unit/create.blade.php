                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="addUnitModalLabel">Add New Unit</h6>
                            ...
                            <div class="modal-body">
                                <form action="{{route('units.store')}}" method="post" >
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="unitName" placeholder="e.g., Kilogram" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="unitType" class="form-label">Short Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="short_name" id="unitType" placeholder="e.g., Weight" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="unitCode" class="form-label">Code <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="code" id="unitCode" placeholder="e.g., KG" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-2 mt-7">
                                        ...
                                        <button type="submit" class="btn btn-primary w-100" id="saveUnitBtn">Add Unit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
