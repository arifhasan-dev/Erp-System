                                        ...
                                        <form action="{{route('customers.update',$customer->id)}}" method="post">
                                            ...
                                            <div class="row g-5">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" name="name" value="{{old('name',$customer->name)}}" id="customerName" placeholder="Enter full name" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="customerEmail" class="form-label">Email <span class="text-danger">*</span></label>
                                                    <input type="email" class="form-control" name="email" value="{{old('email',$customer->email)}}" id="customerEmail" placeholder="Enter email" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="customerPhone" class="form-label">Phone <span class="text-danger">*</span></label>
                                                    <input type="tel" class="form-control" id="customerPhone" name="phone" value="{{old('phone',$customer->phone)}}" placeholder="Enter phone number" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="customerPhone" class="form-label">Address <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="customerPhone" name="address" value="{{old('address',$customer->address)}}" placeholder="Enter phone number" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="customerCompany" class="form-label">Opening Balance</label>
                                                    <input type="number" class="form-control" id="customerCompany" name="opening_balance" value="{{old('opening_balance',$customer->opening_balance)}}" placeholder="Enter company name">
                                                </div>
                                                <div class="col-6">
                                                    <label for="customerDesignation" class="form-label">Credit Limit</label>
                                                    <input type="number" class="form-control" id="customerDesignation" name="credit_limit" value="{{old('opening_balance',$customer->opening_balance)}}" placeholder="Enter designation">
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control" id="customerNotes" name="note" rows="3" placeholder="Enter additional notes">{{$customer->note}}</textarea>
                                                </div>
