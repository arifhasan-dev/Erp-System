                        ...
                        <form method="post" action="{{route('purchases.store')}}">
                            ...
                            <div class="row g-5 mb-5">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" id="purchaseDate" class="form-control" name="invoice_date" value="{{old('invoice_date')}}" required>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input
                                        type="text" name="invoice_no" class="form-control" value="{{ old('invoice_no') }}" placeholder="Enter invoice number">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="table-responsive mb-5">
                                <table class="table table-borderless align-middle text-center text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="items[0][unit_cost]" class="form-control unit-cost" step="0.01" required>
                                        </td>
                                        <td>0</td>
                                        <td>
                                            <input type="number" name="items[0][ordered_quantity]" class="form-control qty" step="0.01" required>
                                        </td>
                                        <td>
                                            <input type="number" name="items[0][discount_amount]" class="form-control discount" value="0" step="0.01">
                                        </td>

                                        <td>
                                            <input type="number" name="items[0][tax_amount]" class="form-control tax" value="0" step="0.01">
                                        </td>
                                        <td>
                                            auto
                                        </td>
                            ...
                            <div class="row g-5">
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="number" class="form-control" name="tax_amount" id="orderTax" placeholder="0.00">
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <label for="discount" class="form-label">Discount ($)</label>
                                    <input type="number" class="form-control" name="discount_amount" id="discount" placeholder="0.00">
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <label for="shipping" class="form-label">Shipping ($)</label>
                                    <input type="number" class="form-control" name="shipping_cost" id="shipping" placeholder="0.00">
                                </div>
                                <div class="col-md-6 col-lg-4">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" name="transaction_no" id="transactionNo" class="form-control @error('transaction_no') is-invalid @enderror" value="{{ old('transaction_no') }}" placeholder="Enter transaction or reference number">
